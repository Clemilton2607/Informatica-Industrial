...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("UEA/InformaticaIndustrial/Sensor/Temperatura")
    client.subscribe("UEA/InformaticaIndustrial/Sensor/Umidade")
...
def on_message(client, userdata, msg):
    try:
        ...
        if msg.topic == "UEA/InformaticaIndustrial/Sensor/Temperatura":
            sensor1.set_value(value)
        elif msg.topic == "UEA/InformaticaIndustrial/Sensor/umidade":
...
mqtt_client.connect("broker.hivemq.com", 1883, 10)  # Altere para o endereço do seu broker
